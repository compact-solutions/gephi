    ...
    public Color getColor(Color edgeColor, Color sourceColor, Color targetColor) {
        switch (mode) {
            ...
            case TARGET:
                return targetColor;
            case MIXED:
                return new Color((int) ((sourceColor.getRed() + targetColor.getRed()) / 2.0),
                        (int) ((sourceColor.getGreen() + targetColor.getGreen()) / 2.0),
                        (int) ((sourceColor.getBlue() + targetColor.getBlue()) / 2.0),
                        (int) ((sourceColor.getAlpha() + targetColor.getAlpha()) / 2.0));
            case CUSTOM:
                return customColor;
        }
        return null;
