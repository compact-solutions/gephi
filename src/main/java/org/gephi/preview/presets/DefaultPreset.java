...
import org.gephi.preview.PreviewPreset;
import org.gephi.preview.PreviewProperty;
...
public class DefaultPreset extends PreviewPreset {
    ...
    public DefaultPreset() {
        super("default-preset");

        properties.put(PreviewProperty.ARROW_SIZE, 3);
        ...
        properties.put(PreviewProperty.EDGE_OPACITY, 100);
        properties.put(PreviewProperty.EDGE_RADIUS, 0);
        properties.put(PreviewProperty.EDGE_THICKNESS, 1);
        ...
        properties.put(PreviewProperty.EDGE_LABEL_OUTLINE_OPACITY, 80);
        ...
        properties.put(PreviewProperty.NODE_BORDER_WIDTH, 1.0);
        properties.put(PreviewProperty.NODE_OPACITY, 100);

        properties.put(PreviewProperty.NODE_LABEL_BOX_COLOR, new DependantColor(DependantColor.Mode.PARENT));
        properties.put(PreviewProperty.NODE_LABEL_BOX_OPACITY, 100);
        ...
        properties.put(PreviewProperty.NODE_LABEL_OUTLINE_OPACITY, 80);
