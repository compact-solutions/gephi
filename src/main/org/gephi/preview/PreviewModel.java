...
public interface PreviewModel {
    ...
    void setItemBuilders(ItemBuilder... itemBuilders);

    ItemBuilder[] getItemBuilders();

    void setRenderTargetBuilders(RenderTargetBuilder... renderTargetBuilders);

    RenderTargetBuilder[] getRenderTargetBuilders();
}
